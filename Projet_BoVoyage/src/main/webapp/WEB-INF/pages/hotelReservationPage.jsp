...
You have chosen the accommodation ${hotel.name} in ${hotel.destination.city}
<br/>
<%-- <form:form method="POST" action="submitResHotel" commandName="formulaTrip" --%>
<%-- 		cssClass="form-horizontal" cssStyle="margin-top:100px;" --%>
<%-- 		enctype="multipart/form-data"> --%>
<%-- 			<form:input cssClass="form-control" id="nameFormTrip" --%>
<%-- 					placeholder="Name" path="nameFormTrip" /> --%>
