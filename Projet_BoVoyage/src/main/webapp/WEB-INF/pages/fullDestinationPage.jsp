...
@supports not (-webkit-background-clip: text){
  ...
  #article93 .effect {
    ...
    -webkit-user-select: none; -moz-user-select: none; -ms-user-select: none; user-select: none; /* not good, but prevent selection from being filtered */
...
<body>
	...
	<div class="imgtext"><img src="photoDest?idDest=${destination.idDest}" style="margin-top:-150px" /></div>
	<center> <section id="article93" class="crayon article-css-93 demoTime"><p class="effect">${destination.city}</p></section></center>
	<br/><br/><br/><br/><br/>
		    <!-- Colonne vide -->
...
<table>
		<tr>
			<td><img src="photoDest?idDest=${destination.idDest}" class="imgbox"/></td>
			<td style="padding-left:15px;"><b>${destination.city}, ${destination.country}</b><br/>
			<p style="width:350px; overflow:auto;text-align:justify">${destination.description}</p></td>
